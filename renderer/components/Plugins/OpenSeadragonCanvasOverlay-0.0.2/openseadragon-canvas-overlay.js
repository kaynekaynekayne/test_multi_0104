...
(function() {
    ...
    Overlay.prototype = {
        ...
        resize: function() {
            ...
            // 20220905_LBK : [modify] openseadragon v3.1.0 contentSize null
            // this.imgWidth = this._viewer.viewport.contentSize.x;
            // this.imgHeight = this._viewer.viewport.contentSize.y;
            // this.imgAspectRatio = this.imgWidth / this.imgHeight;

            this.imgWidth = this._viewer.viewport._contentSize.x;
            this.imgHeight = this._viewer.viewport._contentSize.y;
            this.imgAspectRatio = this.imgWidth / this.imgHeight;
